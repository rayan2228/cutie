...
<body class="layout-default">
    ...
    <div class="mdk-header-layout js-mdk-header-layout">
        ...
        <div id="header" class="m-0 mdk-header js-mdk-header" data-fixed>
            <div class="mdk-header__content">

                <div class="pr-0 navbar navbar-expand-sm navbar-main navbar-dark bg-dark" id="navbar" data-primary>
                    <div class="p-0 container-fluid">
                        ...
                        <form class="flex search-form d-none d-sm-flex" action="index.html">
                        ...
                        <ul class="ml-auto nav navbar-nav d-none d-md-flex">
                            <li class="nav-item dropdown">
                                ...
                                <div id="notifications_menu" class="dropdown-menu dropdown-menu-right navbar-notifications-menu">
                                    <div class="py-2 dropdown-item d-flex align-items-center">
                                        <span class="flex m-0 navbar-notifications-menu__title">Notifications</span>
                                    ...
                                    <a href="javascript:void(0);" class="text-center dropdown-item navbar-notifications-menu__footer">View All</a>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                            <li class="nav-item dropdown">
                                ...
                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="../profile/edit_profile.php"><i class="material-icons">edit</i> Edit account</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="../auth/logout.php"><i class="material-icons">exit_to_app</i> Logout</a>
                                </div>
                            </li>
                        </ul>
