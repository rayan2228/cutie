        ...
        <form action="login_data.php" method="POST">
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input id="email_2" type="email" class="form-control form-control-prepended <?= isset($_SESSION["error"]) ? "is-invalid" : "" ?>" placeholder="john@doe.com" name="email">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input id="password_2" type="password" class="form-control form-control-prepended <?= isset($_SESSION["error"]) ? "is-invalid" : "" ?>" placeholder=" Enter your password" name="password">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
